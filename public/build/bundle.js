...
var app = (function () {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor, remount) {
    			...
    			dispose = [
    				...
    				listen_dev(button16, "click", /*click_handler_16*/ ctx[21], false, false, false),
    				listen_dev(button17, "click", /*click_handler_17*/ ctx[22], false, false, false)
    			];
    		},
    		p: function update(ctx, [dirty]) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const click_handler_16 = () => equal();
    	const click_handler_17 = () => back();
